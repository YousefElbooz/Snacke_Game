...
void Gamestate::initPauseMenu()
{
    ...
    this->Pmenu[0]->addButton(1, static_cast <float>(this->window->getSize().x)/2, 400.f, "Continuoe");
    this->Pmenu[0]->addButton(0, static_cast <float>(this->window->getSize().x)/2, 700.f, "Quit");
    this->Pmenu[1]->addButton(1, static_cast <float>(this->window->getSize().x)/2, 400.f, "Continuoe");
    this->Pmenu[1]->addButton(0, static_cast <float>(this->window->getSize().x)/2, 700.f, "Quit");
}
