...
private:
    ...
    sf::Sprite wallleft;
    sf::Sprite wallright;
    sf::Sprite wallrbottom;
    sf::Sprite wallrmid;
    sf::Texture walltextver;
    sf::Texture walltexthor;
    float speed=1.75;
    PauseMenuState* PmenuP;
    PauseMenuState* PmenuD;
    bool paused = false;
    bool is_die = false;
    ...
    sf::Font scorefont;
    int score = 0, highscore = 0, num = 4,level=1;
    unsigned int dir;
    ...
    //fun 
    void initFonts();
    void snakedirection(const float& dt);
    void createsnake();
    void eatingfood();
    void eatingbomb();
    void Snackedie();
...
public:
    ...
    void renderWallFens(sf::RenderTarget* target);
